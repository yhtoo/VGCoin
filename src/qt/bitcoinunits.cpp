...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("VGCoins");
    case mBTC: return QString("Milli-VGCoins (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-VGCoins (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
