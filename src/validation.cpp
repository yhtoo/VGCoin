...
const std::string strMessageMagic = "VGCoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache, bool rawTx)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s VGCoin additional fees, %d delta bytes\n",
...
//////////////////////////////////////////////////////////////////
    ...
    if(pindex->nHeight > 5000 && !Params().GetConsensus().fPoSNoRetargeting) {
        ...
        if(pindex->nMoneySupply > (uint64_t)(1000000000ull + ((pindex->nHeight - 5000) * 40ull)) * COIN){
    ...
    try {
        ...
        while (!blkdat.eof()) {
            ...
            try {
                ...
                // But for VGCoin PoS we need to sync this after every block to ensure txdb is populated for
